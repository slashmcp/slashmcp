...
create table if not exists document_embeddings (
    ...
    embedding vector(3072) not null, -- text-embedding-3-large uses 3072 dimensions
...
comment on column document_embeddings.embedding is 'Vector embedding generated by OpenAI text-embedding-3-large (3072 dimensions)';
